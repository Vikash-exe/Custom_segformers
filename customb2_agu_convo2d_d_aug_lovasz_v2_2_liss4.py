# -*- coding: utf-8 -*-
"""CustomB2_AGU_Convo2D_D-aug_Lovasz_V2.2_LISS4
...
class SegmentationDataset(Dataset):
    def __init__(self, images_dir, masks_dir, image_size=512, num_classes=5, normalize=True, transform=None):
...
save_dir = "/content/drive/MyDrive/2.2_CustomB2_CE+Lovasz_lulc"
